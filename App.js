...
import TanahLongsorTambahScreen from "./src/views/screens/bencana/tanahLongsor/TanahLongsorTambahScreen";
...
import CoronaBeritaDetail from "./src/views/screens/lawanCorona/CoronaBeritaDetail";
...
const createHomeStack = () => {
    return (
        ...
        <Stack.Navigator screenOptions={{headerShown: false}}>
            ...
            <Stack.Screen name="CoronaBeritaDetail" component={CoronaBeritaDetail}/>
        </Stack.Navigator>
        // </Stack.Navigator>
        /*</NavigationContainer>*/
    )
...
const App = () => {
    ...
    const authContextValue = useMemo(
        () => ({
            signIn: async (data) => {
                if (data.masuk === true) {
                    dispatch({type: 'SIGN_IN', token: data.token, pegawai: data.dataPegawai});
